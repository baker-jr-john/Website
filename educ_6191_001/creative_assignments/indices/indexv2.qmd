...
grid_search_rf = GridSearchCV(estimator=model_rf, param_grid_rf=param_grid_rf,
...
All required explanations and files are included in this document and the accompanying attachments. The code and data are organized to facilitate replication and further analysis. Please let me know if additional information is needed.